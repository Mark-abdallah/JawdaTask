...
{
    [DbContext(typeof(Product_TaskDbContext))]
    [Migration("20211115001242_ImagePropertyIsAdded")]
    partial class ImagePropertyIsAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Product_Task.Products.Category", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Product_Task.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Product_Task.Products.Product", b =>
                {
                    b.HasOne("Product_Task.Products.Category", null)
                        .WithMany()
